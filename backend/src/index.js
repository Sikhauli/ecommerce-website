...
const clientWebsite =  "https://ecommerce-website-vv87.onrender.com";
const adminWebsite =  "https://ecommerce-website-vv87.onrender.com";
...
app.use(
  cors({
    origin: [clientWebsite, adminWebsite],
    credentials: true,
  })
);
